...
export const Category = () => {
  return (
    <div className="flex justify-center flex-wrap md:flex-nowrap my-8">
      <NavLink
        className="p-4 flex flex-col justify-center items-center bg-[#494949] rounded-[50%] m-1 md:mr-8 no-underline w-24 h-24 cursor-pointer transform scale-90"
        to={"/cuisine/Italian"}
      >
